...
const trustBadges = [{
  ...
  subtext: "AU License #12345"
}, {
  icon: Clock,
  text: "Melbourne-Based",
  subtext: "Same Day Service"
}, {
  icon: DollarSign,
  ...
  return <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 py-24 lg:py-32">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-secondary/15 text-secondary px-5 py-2.5 rounded-full mb-8 animate-fade-up backdrop-blur-md border border-secondary/20">
            <CheckCircle className="w-4 h-4" />
            <span className="font-medium text-sm">Melbourne's Trusted HVAC Experts</span>
          </div>

          {/* Heading */}
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-primary-foreground mb-6 leading-[1.1] animate-fade-up" style={{
          animationDelay: "0.1s"
        }}>
          ...
          {/* Subheading */}
          <p className="text-lg sm:text-xl text-primary-foreground/75 mb-10 leading-relaxed max-w-2xl animate-fade-up" style={{
          animationDelay: "0.2s"
        }}>
          ...
          animationDelay: "0.3s"
            ...
            <Button variant="heroOutline" size="xl" asChild>
              <a href="tel:0412345678">Call 0417 066 737</a>
            </Button>
          </div>

          {/* Trust Badges */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 animate-fade-up" style={{
          animationDelay: "0.4s"
        }}>
            {trustBadges.map((badge, index) => <div key={index} className="glass rounded-2xl p-4 flex items-center gap-4 hover-lift">
